...
var d=typeof document!=="undefined"?c("6"):c("a");d.version="3.0.14";d.requestFrame=function(h){g.request(h);return this;};d.cancelFrame=function(h){g.cancel(h);
...
};var i=[];var g=function(k){var l;while(l=i.shift()){l(k||(k=+new Date()));}};var j=function(l){var k=h.indexOf(i,l);if(k>-1){i.splice(k,1);}};var e=function(l){var k=i.push(l);
if(k===1){d(g);}return function(){j(l);};};f.request=e;f.cancel=j;},"3":function(e,d,g,c){var k=e("4");var j=Array.prototype;var l=k({filter:j.filter,indexOf:j.indexOf||function(p,q){for(var n=this.length>>>0,o=q<0?Math.max(0,n+q):q||0;
...
}}return p;},forEach:j.forEach||function(q,p){for(var o=0,n=this.length>>>0;o<n;o++){if(o in this){q.call(p,this[o],o,this);}}},every:j.every,some:j.some});
l.isArray=Array.isArray;var f={};var m="pop,push,reverse,shift,sort,splice,unshift,concat,join,slice,lastIndexOf,reduce,reduceRight".split(",");for(var h=0,b,a;
b=m[h++];){if(a=j[b]){f[b]=a;}}l.implement(f);d.exports=l;},"4":function(b,e,a,f){var d=b("5"),g=Array.prototype.slice;var c=d({mutator:function(h,i){this[h]=function(j){var k=arguments.length>1?g.call(arguments,1):[];
...
return d(h);};},"5":function(f,d,g,c){var j=function(k,l){return Object.hasOwnProperty.call(k,l);};var i=function(k,n,m){for(var l in k){if(n.call(m,k[l],l,k)===false){break;
}}return k;};var h=Object.create||function(k){var l=function(){};l.prototype=k;return new l();};var e=function(k,l){this.prototype[k]=l;};var b=function(k){i(k,function(m,l){if(l!=="constructor"&&l!=="inherits"&&l!=="mutator"){this.mutator(l,m);
}},this);return this;};var a=function(l){var m=l.inherits,o;if(m){o=m.prototype;}var k=j(l,"constructor")?l.constructor:m?function(){return o.constructor.apply(this,arguments);
}:function(){};if(m){var n=k.prototype=h(o);k.parent=o;n.constructor=k;}k.mutator=l.mutator||m&&m.mutator||e;k.implement=b;return k.implement(l);};a.each=i;
a.has=j;a.create=h;d.exports=a;},"6":function(k,h,ae,d){var O=k("1"),b=k("2");var ad=b.cancel,X=b.request;var E=k("5"),o=k("3"),z=k("7");var aj=z.camelize,aa=z.clean,P=z.capitalize;
var N=o.map,c=o.forEach,F=o.indexOf;var m=k("9");var H=k("a");var R={};var l=function(e){return R[e]||(R[e]=z.hyphenate(e));};var ag=function(e){return Math.round(e*1000)/1000;
...
if(e==="ms"){R[at]="-ms-"+l(ar);}if(s.style[at]!=null){S[ar]=at;}});});var n=S.transition,D=S.transform;if(n==="OTransition"){n=null;}var ac,W;if(!n&&D){(function(){var av=k("c");
...
this.set(this.get());}}}}}return this;},resetCSS:function(ar){var aw=w(this.node),av=aw(n+"Property").replace(/\s+/g,"").split(","),au=aw(n+"Duration").replace(/\s+/g,"").split(","),e=aw(n+"TimingFunction").replace(/\s+/g,"").match(/cubic-bezier\([\d-.,]+\)|([a-z-]+)/g);
...
}):"";}});B.parse=function(at,ar,e){return(y[aj(at)]||G)(ar,e);};h.exports=B;},"7":function(c,e,a,f){var d=c("4");var b=d({inherits:c("8"),clean:function(){return b.trim((this+"").replace(/\s+/g," "));
},camelize:function(){return(this+"").replace(/-\D/g,function(g){return g.charAt(1).toUpperCase();});},hyphenate:function(){return(this+"").replace(/[A-Z]/g,function(g){return"-"+g.toLowerCase();
});},capitalize:function(){return(this+"").replace(/\b[a-z]/g,function(g){return g.toUpperCase();});}});e.exports=b;},"8":function(e,d,g,c){var l=e("4");
var j=String.prototype;var k=l({trim:j.trim||function(){return(this+"").replace(/^\s+|\s+$/g,"");}});var f={};var m="charAt,charCodeAt,concat,indexOf,lastIndexOf,match,quote,replace,search,slice,split,substr,substring,toLowerCase,toUpperCase".split(",");
for(var h=0,b,a;b=m[h++];){if(a=j[b]){f[b]=a;}}k.implement(f);d.exports=k;},"9":function(g,f,h,e){var d=g("5"),j=g("3").prototype;var k=0;var c=function(l){return l===e?"global":l.uniqueNumber||(l.uniqueNumber="n:"+(k++).toString(36));
...
return m;});},forEach:j.forEach,map:j.map,filter:j.filter,every:j.every,some:j.some});f.exports=i;},a:function(h,b,r,n){var c=h("5"),a=h("2").request,k=h("b");
...
return this;},stop:function(){s.stop();return this;}};};d.prototype=f.prototype;b.exports=d;},b:function(b,c,a,d){c.exports=function(h,j,f,i,l){var g=function(n){var m=1-n;
